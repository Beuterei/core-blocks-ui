...
export const WithFooter: Story = {
    render: () => (
        <Card>
            ...
            <CardContent>
                <p>Subscribe to our newsletter to receive weekly updates and exclusive content.</p>
            </CardContent>
    ...
    render: () => (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Join us for the biggest React event of the year</CardDescription>
                <CardAction>
                    <Button size="icon" variant="ghost">
                        <Bell />
                    </Button>
