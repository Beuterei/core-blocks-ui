...
export const Tabs = ({ className, ...props }: ComponentProps<typeof TabsPrimitiveRoot>) => (
    <TabsPrimitiveRoot
...
export const TabsList = ({ className, ...props }: ComponentProps<typeof TabsPrimitiveList>) => (
    <TabsPrimitiveList
        className={cn(
