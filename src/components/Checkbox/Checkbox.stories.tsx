...
const CheckboxWithLabel = (args: React.ComponentProps<typeof Checkbox>) => {
    const id = useId();
    return (
...
const CheckboxWithIcons = () => {
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
                <Checkbox defaultChecked id={likedId} />
